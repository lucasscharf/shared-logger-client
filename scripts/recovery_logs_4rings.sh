...
scp lucas123@$neptune:/tmp/execucaoLogger $outputFile/logger_2.csv
scp lucas123@$neptune:/tmp/loggerStatsOutdated $outputFile/logger_2_latency.csv
scp lucas123@$uranus:/tmp/execucaoLogger $outputFile/logger_1.csv
scp lucas123@$uranus:/tmp/loggerStatsOutdated $outputFile/logger_1_latency.csv
