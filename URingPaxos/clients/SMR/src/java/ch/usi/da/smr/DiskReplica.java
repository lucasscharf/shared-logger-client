 ...
 */
public class DiskReplica extends Replica {
	static {
	...
	private final static Logger logger = Logger.getLogger(DiskReplica.class);
	...
	public DiskReplica(String token, int ringID, int nodeID, int snapshot_modulo, String zoo_host) throws Exception {
		this.nodeID = nodeID;
		this.token = token;
